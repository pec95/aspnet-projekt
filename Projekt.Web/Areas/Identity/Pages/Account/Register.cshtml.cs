...
namespace Projekt.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new Korisnik { UserName = Input.UserName, Email = Input.Email, KlubIdNajdrazi = Input.KlubIdNajdrazi };
